...
В [этом](https://github.com/yuriybylinkin/git_stat) репозитории вы можете найти полный текст скрипта. Применить его у себя очень просто - проверьте, установлен ли у вас вообще **oscript**, **git** и **git bash**,  клонируйте **git-quick-stats**, проверьте правильность путей до утилиты **git bash** и **git-quick-stats**.

И анализируйте.

![table](https://github.com/yuriybylinkin/git_stat/raw/main/Image/07-Table.png)