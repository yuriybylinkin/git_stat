...
Формируем данные статистики и кладем получившиеся строчки в общую таблицу.
...
В этом репозитории вы можете найти полный текст скрипта. Применить его у себя очень просто - проверьте, установлен ли у вас вообще **git** и **git bash**,  проверьте правильность путей до утилиты **git bash** и **git-quick-stats**. Укажите нужный период начала.